		                ...
		                case "step2":
							...
							try {
				                ...
				                $sql_query = "SET SQL_MODE=\"NO_AUTO_VALUE_ON_ZERO\";\n"
				                	. "SET time_zone = \"+00:00\";\n"
				                	. "CREATE TABLE IF NOT EXISTS `aircraft` (`id` int(11) NOT NULL auto_increment, `active` tinyint(1) NOT NULL default '1', `tailnumber` char(25) NOT NULL, `makemodel` char(50) NOT NULL, `emptywt` float NOT NULL, `emptycg` float NOT NULL, `maxwt` float NOT NULL, `cgwarnfwd` float NOT NULL, `cgwarnaft` float NOT NULL, `weighing_date` DATE NULL, `weighing_sheet_url` TEXT NULL, `fuelunit` char(25) NOT NULL, PRIMARY KEY  (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1;\n"
				                	...
				                	. "CREATE TABLE IF NOT EXISTS `aircraft_weights` (`id` int(11) NOT NULL auto_increment, `tailnumber` int(11) NOT NULL, `order` smallint(3) NOT NULL, `item` char(50) NOT NULL, `weight` float NOT NULL, `maxweight` FLOAT NULL, `arm` float NOT NULL, `emptyweight` enum('true','false') NOT NULL default 'false', `fuel` enum('true','false') NOT NULL default 'false', `fuelwt` float NULL, PRIMARY KEY  (`id`)) ENGINE=MyISAM  DEFAULT CHARSET=latin1;\n"
