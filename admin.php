                ...
                if(!isset($_REQUEST['active'])) {
                  ...
                  $newActive = $_REQUEST['active'];
		      		...
		      		case "loading":
		                  ...
		                  if ($_REQUEST['new_fuel']=="true") {
		                    $sql_query = $sql_query . ", `fuelwt`, `fuel`";
		                  }
		                  if ($_REQUEST['new_emptyweight']=="true") {
		                    $sql_query = $sql_query . ", `emptyweight`";
		                  }
		                  ...
		                  if ($_REQUEST['new_fuel']=="true") {
		                    $sql_query = $sql_query . ", '" . $_REQUEST['new_fuelwt'] . "', 'true'";
		                  }
		                  if ($_REQUEST['new_emptyweight']=="true") {
		                  ...
		                  if ($_REQUEST['emptyweight']=="true") {
		                    $sql_query = $sql_query . ", `emptyweight` = 'true'";
		                  }
		                  if ($_REQUEST['fuel']=="true") {
		                    $sql_query = $sql_query . ", `fuel` = '" . $_REQUEST['fuel'] . "', `fuelwt` = '" . $_REQUEST['fuelwt'] . "'";
		                  }
      ...
      if (isset($_REQUEST['message'])) {
	        ...
	        if ($_REQUEST['what']=="Edit") {
	          ...
	          if ($_REQUEST['password']!="") {
	            $sql_query = $sql_query . "`password` = '" . password_hash($_REQUEST['password'], PASSWORD_DEFAULT) . "', ";
	          }
